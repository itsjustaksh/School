...
HD_PWD='C:/Users/googl/Documents/Anything Relevant/University/4th Year/4310/Labs/Lab3/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log processor_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source processor_tb.tcl
